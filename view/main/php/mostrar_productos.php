      ...
      <div class="col-12 col-sm-6 col-md-4 col-xl-3 mt-5 lol">
        <div id="<?php echo $dato['ID']; ?>" class="card">
          ...
          if ($dato['STOCK'] < 5 && $dato['STOCK'] > 0) {
           if($dato['SPONSORED'] == 'N'){?>
            <span class="badge badge-info font-weight-bold blink mt-3 ml-3 prom-badge">¡Quedan pocos!</span>
            <?php }else{?>
            <span class="badge badge-info font-weight-bold blink mt-3 prom-badge-low">¡Quedan pocos!</span>
            <?php } }?>
            ...
            <div class="card-block">
              ...
              <form action="index.php?controller=productos&action=show_product_page&id=<?php echo $dato['ID'];?>&sc=<?php echo $dato['CATEGORY']; ?>" method="post">
                <button class="btn btn-success col-12" type="submit"></a>Comprar</button>
              </form>
              <form action="index.php?controller=order&action=insert&id=<?php echo $dato['ID'];?>" method="post">
                <button class="btn btn-primary btn-sm col-12 mt-2" type="submit"></a>Al carro</button>
              </form>
